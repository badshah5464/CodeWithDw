...
}, //! React
{
  ...
  link: "./React-useState-Method-08.html#dropDownClassReact",
  pageName: "DropDown with class in React" //  id: "",
...
function searchFunction() {
  ...
  for (e = document.getElementById("search"), s = e.value.toUpperCase(), a = document.getElementsByClassName("searchMenu"), n = document.getElementsByClassName("searchList"), c = 0; c < n.length; c++) {
    t = n[c].getElementsByClassName("item")[0], t.innerHTML.toUpperCase().indexOf(s) > -1 ? n[c].style.display = "" : n[c].style.display = "none";
  }
}
...
searchIcon.addEventListener("click", function () {
  ...
  addMenu.innerHTML += "<li class=\"searchList\"><a href=\"".concat(e.link, "\" class=\"item\">").concat(e.pageName, "</a></li>");
});